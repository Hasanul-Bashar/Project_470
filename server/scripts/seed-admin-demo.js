    ...
    const listings = await Listing.insertMany([
      {
        ...
        description: 'A stunning fully-furnished 3-bedroom duplex apartment with modern amenities, 24/7 security, a rooftop garden, and a dedicated car park. Perfect for families looking for premium urban living.',
      ...
      },
      {
        ...
        description: 'A well-lit, spacious sublet room in the heart of Banani. Features access to European-style modular kitchen, high-speed fibre internet, and a calm, tree-lined street view.',
